...
## 🚀 5. ข้อความเริ่มต้นสำหรับเปิด New Conversation (Starter Prompt)
เมื่อคุณพร้อมจะเริ่มพัฒนา สามารถคัดลอกข้อความด้านล่างนี้ไปวางใน New Conversation ได้ทันที:

```
สวัสดีครับ ต้องการเริ่มพัฒนาเว็บแอป "PTN Time Attendant" (ระบบบันทึกเวลาทำงาน พิกัด GPS ขาด ลา มา สาย และขอ OT สำหรับพนักงานผ่านมือถือ)

ข้อมูลอ้างอิงของโปรเจกต์:
1. เชื่อมต่อกับ Cloudflare D1 Database เดียวกันกับ PTN Payroll:
   - database_name: ptn_payroll_db
   - database_id: 5a72c7dd-fedb-4583-85f9-b29964845560
   - ใช้ตารางพนักงาน employees ที่มีอยู่แล้วในฐานข้อมูล
2. รายละเอียดสเปกและตารางเวลาถูกบันทึกไว้ในไฟล์ PTN_TIME_ATTENDANT_SPEC.md เรียบร้อยแล้ว
3. เป้าหมายขั้นแรก: ออกแบบหน้า Mobile Web App สำหรับพนักงานลงเวลาเข้า-ออกงานด้วย GPS และระบบขอลา/ขอ OT ครับ
```
